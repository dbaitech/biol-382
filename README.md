...
1. Reimplements a selection of the original paper's model validations (see Section 5 of Giannari et al.)
2. Implements and demonstrates the synaptic scaling extension
